...
COMMENT ON COLUMN special_needs.title IS 'Title of the special need';
COMMENT ON COLUMN special_needs.description IS 'Description of the special need';
COMMENT ON COLUMN special_needs.url IS 'URL pointing to additional information about the special need';

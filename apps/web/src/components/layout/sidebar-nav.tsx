...
import { SidebarNavItem } from "@web/src/types/nav"

export interface SidebarNavProps {
  items: SidebarNavItem[]
}

export const DocsSidebarNav = ({ items }: SidebarNavProps) => {
...
export const SidebarNavItems = ({ items, pathname }: SidebarNavItemsProps) => {
  return items?.length ? (

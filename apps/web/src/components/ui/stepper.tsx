  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "data-[active=true]:bg-primary data-[active=true]:border-primary data-[active=true]:text-primary-foreground dark:data-[active=true]:text-primary",
        "data-[current=true]:ring-ring data-[current=true]:bg-primary data-[current=true]:text-primary-foreground data-[current=true]:outline-none data-[current=true]:ring-2 data-[current=true]:ring-offset-2",
